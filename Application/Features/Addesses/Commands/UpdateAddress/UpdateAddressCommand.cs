...
namespace Application.Features.Addesses.Commands.UpdateAddress
{
    public class UpdateAddressCommand:IRequest<bool>
    {
        ...
        public UpdateAddressCommand() : this(null, null, null!, null, null!, null, null!, null!, null, null!)
        {

        }

        public UpdateAddressCommand(string? unitNumber, string? streetNumber, string addressEN1, string? addressEN2, string addressAR1, string? addressAR2, string city, string region, string? postCode, string country)
        {
